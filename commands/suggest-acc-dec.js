            ...
            command
                ...
                .addStringOption((option) =>
                    option
                        .setName("message_id")
                        .setDescription(
                            "Message ID Of Suggestion You Want To Accept",
                        )
                        .setRequired(true),
                )
                // Accept Message
            ...
            command
                ...
                .addStringOption((option) =>
                    option
                        .setName("message_id")
                        .setDescription(
                            "Message ID Of Suggestion You Want To Decline",
                        )
                        .setRequired(true),
                )
                // Decline Message
            ...
            case "accept":
                try {
                    ...
                    await interaction.reply({
                        content: `An Error Occured, Maybe Message ID Is Wrong Or Couldn't Edit Embed`,
                    });
                    console.log(error);
                }
                break;
