...
osutils.cpuUsage(function(v) {
    ...
    .addFields(
        ...
        { name: "VPS CPU Cores: ", value: `${osutils.cpuCount()}` + " Cores" },
        { name: "Total Memory: ", value: `${osutils.totalmem().toString().split(".")[0]}` + "." + osutils.totalmem().toString().split(".")[1].split('')[0] + osutils.totalmem().toString().split(".")[1].split('')[1] + "MB" }
    );
