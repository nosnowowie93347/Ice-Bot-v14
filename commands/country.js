        ...
        try {
            ...
            const countryEmbed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    {
                        name: `Continent`,
                        value: `${data.continents.join(", ") || "N/A"}`,
                        inline: true,
                    },
                    {
                        name: `Capital`,
                    ...
                    {
                        name: `Population`,
                        value: `${data.population.toLocaleString() || "N/A"}`,
                        inline: true,
                    },
                    {
                        name: `Area`,
                        value: `${data.area.toLocaleString() || "N/A"}`,
                        inline: true,
                    },
                    {
                        name: `Languages`,
                    ...
                    {
                        name: `Timezones`,
                        value: `${Object.values(data.timezones)?.join(", ") || "N/A"}`,
                        inline: true,
                    },
                    {
                        name: `Flag Information`,
                        value: `${data.flags.alt || "N/A"}`,
                        inline: true,
                    },
                )
                .setColor("Random")
            ...
            await interaction.editReply({
                content: `Their Was An Error While Getting Data From API, Try Again Later`,
                ephemeral: true,
            });
            await wait(6000);
